...
function pre_install(){
    ...
    read -p "(Default password: Bigtintin):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="Bigtintin"
    echo
    echo "---------------------------"
    ...
    echo
    echo "Press any key to start...or Press Ctrl+C to cancel按住退出安装"
    char=`get_char`
